...
<br>
  <div class="container">
    ...
    <div class="table-responsive">
      <table class="table table-bordered table-hover ">
        ...
        <?php
          ...
          ?>
          <script>
          location.replace("cartempty.php");
          </script>
          <?php
        }
        ?>
    ...
    <center>	<a href="checkout.php"><button type="submit"  id="myBtn" value="Checkout"name="Checkout"class="btn btn-success input-lg"> Continue to Checkout</button></a></center>
